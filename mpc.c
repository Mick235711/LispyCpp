...
mpc_parser_t* mpca_grammar_st(const char* grammar, mpca_grammar_st_t* st)
{
    ...
    mpc_define(Base, mpc_or(5,
                            ...
                            mpc_tok(
                                mpc_and(3, mpcaf_fold_regex, mpc_regex_lit(), mpc_many(mpcf_strfold, mpc_oneof("ms")),
                                        mpc_lift_val(st), free, free)),
                            mpc_apply_to(mpc_tok_braces(mpc_or(2, mpc_digits(), mpc_ident()), free), mpcaf_grammar_id,
                                         st),
...
static mpc_err_t* mpca_lang_st(mpc_input_t* i, mpca_grammar_st_t* st)
{
    ...
    mpc_define(Stmt, mpc_and(5, mpca_stmt_afold,
                             mpc_tok(mpc_ident()), mpc_maybe(mpc_tok(mpc_string_lit())), mpc_sym(":"), Grammar,
                             mpc_sym(";"),
